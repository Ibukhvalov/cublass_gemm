...
#include "macro.hpp"
#include "utils.hpp"
#include "kernels/tf32_tensor_core_ptx_async_warp64x32.cuh"
...
__global__ void tf32_tensor_core_ptx_async_warp64x32_kernel(
...
void Tf32TensorCorePtxAsyncWarp64x32Kernel::launch(tf32_ptx_async_warp64x32_fp_t* dA, tf32_ptx_async_warp64x32_fp_t* dB, tf32_ptx_async_warp64x32_fp_t* dC, int m, int n, int k) {
    CHECK_CUDA(cudaFuncSetAttribute(
        tf32_tensor_core_ptx_async_warp64x32_kernel,
    ...
    tf32_tensor_core_ptx_async_warp64x32_kernel<<<grid_size, block_size, kSharedBytes>>>(dA, dB, dC, m, n, k);
}
