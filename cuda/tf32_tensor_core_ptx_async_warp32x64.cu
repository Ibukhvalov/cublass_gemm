...
__global__ void tf32_tensor_core_ptx_async_warp32x64_kernel(
...
void Tf32TensorCorePtxAsyncWarp32x64Kernel::launch(tf32_ptx_async_warp32x64_fp_t* dA, tf32_ptx_async_warp32x64_fp_t* dB, tf32_ptx_async_warp32x64_fp_t* dC, int m, int n, int k) {
    CHECK_CUDA(cudaFuncSetAttribute(
        tf32_tensor_core_ptx_async_warp32x64_kernel,
    ...
    tf32_tensor_core_ptx_async_warp32x64_kernel<<<grid_size, block_size, kSharedBytes>>>(dA, dB, dC, m, n, k);
}
