#include "kernel.hpp"
#include "utils.hpp"
#include "kernels/tf32_tensor_core_block128x64_bk64.cuh"
...
__global__ void tf32_tensor_core_block128x64_bk64_kernel(
...
void Tf32TensorCoreBlock128x64Bk64Kernel::launch(tf32_block128x64_bk64_fp_t* dA, tf32_block128x64_bk64_fp_t* dB, tf32_block128x64_bk64_fp_t* dC, int m, int n, int k) {
    dim3 block_size(kWarpSize, kWarpsPerBlock);
    dim3 grid_size(::ceil_div(n, kBlockN), ::ceil_div(m, kBlockM));
    tf32_tensor_core_block128x64_bk64_kernel<<<grid_size, block_size>>>(dA, dB, dC, m, n, k);
}
